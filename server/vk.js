...
// 214 — «добавление комментария запрещено» у записи на стене: тот же смысл,
// что 801 у видео, только для пути wall.createComment.
const VK_FATAL_ERROR_CODES = new Set([14, 15, 100, 214, 801]);
