...
// слов для посимвольной склейки кода («ноль один ноль» → «010»); выводим из
// UNIT_WORDS, чтобы наборы слов не разъезжались.
...
const DIGIT_WORDS = new Map(
  [...UNIT_WORDS].map(([word, value]) => [word, String(value)]),
);
