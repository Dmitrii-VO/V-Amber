...
В проекте более 290 тестов, покрывающих парсинг, детекцию цен, логику
бронирования и интеграцию с API (через моки). Каждый push в `main` прогоняет
тесты в CI перед выпуском релиза (`.github/workflows/release.yml`).
