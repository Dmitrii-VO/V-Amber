...
// http-server тянет server/config.js, а тот через dotenv вливает .env — если у
// разработчика задан API_TOKEN, все /api/* ответят 401. Поэтому подставляем
// тот же токен в заголовок; на CI он не задан и заголовка просто не будет.
