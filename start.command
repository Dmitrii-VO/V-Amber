...
if [ "$NEED_SETUP" = true ]; then
  ...
  if _confirm "V-Amber — МойСклад" \
    ...
    MS_LOGIN=$(_ask \
      "V-Amber — МойСклад (1/4)" \
      "Логин МойСклад\n\nВведите логин от аккаунта МойСклад:" \
      "")

    MS_PASSWORD=$(_ask \
      "V-Amber — МойСклад (2/4)" \
      "Пароль МойСклад\n\nВведите пароль от аккаунта МойСклад:" \
      "")

    MS_ORG=$(_ask \
      "V-Amber — МойСклад (3/4)" \
      "UUID организации МойСклад\n\nГде взять:\nМойСклад → Настройки → Юр. лица\n→ откройте организацию → скопируйте UUID из URL\n\nВставьте UUID:" \
      "")

    MS_STORE=$(_ask \
      "V-Amber — МойСклад (4/4)" \
