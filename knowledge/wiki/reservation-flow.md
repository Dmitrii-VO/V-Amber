...
эфире у покупателя ровно **одна** живая бронь на открытых лотах — она снимается
сразу (`path: "no_code_single"`). Ноль или несколько — прежнее поведение:
...
падает — заказ не трогаем. 29.08 такими остались VK03154 и VK03163.
